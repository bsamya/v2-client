export const addressList: Address[] = [
  {
    addressId: 'A001',
    type: 'buyer',
    company: 'Echo Imports Ltd.',
    name: 'Maria Lopez',
    street: '120 King Street W, Suite 900',
    city: 'Toronto',
    state: 'ON',
    postalCode: 'M5H 1A9',
    country: 'Canada',
    phone: '+1 416 555 7821',
    email: 'maria.lopez@echoimports.ca',
  },
  {
    addressId: 'A002',
    type: 'consignee',
    ...
    name: 'Ahmed Khan',
    street: 'Building 4, Warehouse 21, Industrial Zone',
    city: 'Dubai',
    state: 'DU',
    postalCode: '00000',
    country: 'UAE',
    phone: '+971 50 213 4456',
    email: 'ahmed.khan@sunrisetrading.ae',
  },
  {
    addressId: 'A003',
    type: 'buyer',
    ...
    name: 'John Peterson',
    street: '1420 Market Street',
    city: 'Philadelphia',
    state: 'PA',
    postalCode: '19102',
    country: 'USA',
    phone: '+1 267 321 9900',
    email: 'john.peterson@bluehorizon.com',
  },
  {
    addressId: 'A004',
    type: 'other',
    company: 'Nordic Exporters AB',
    name: 'Anna Svensson',
    street: 'Sveavägen 44',
    city: 'Stockholm',
    state: 'ST',
    postalCode: '113 59',
    country: 'Sweden',
    phone: '+46 8 555 22770',
    email: 'anna.svensson@nordicexp.se',
  },
  {
    addressId: 'A005',
    type: 'consignee',
    company: 'Pacific Ocean Freight',
    name: 'Kenji Yamamoto',
    street: '3-12-6 Shibuya',
    city: 'Tokyo',
    state: 'TK',
    postalCode: '150-0002',
    country: 'Japan',
    phone: '+81 3 5428 0100',
    email: 'kenji.y@pacificocean.jp',
  },
  {
    addressId: 'A006',
    type: 'buyer',
    company: 'Luna Cosmetics Inc.',
    name: 'Sophia Hernandez',
    street: '8700 NW 36th Street, Suite 110',
    city: 'Doral',
    state: 'FL',
    postalCode: '33166',
    country: 'USA',
    phone: '+1 305 444 8890',
    email: 'sophia@lunacosmetics.com',
  },
  {
    addressId: 'A007',
    type: 'other',
    company: 'Green Planet Distributors',
    name: 'Oliver White',
    ...
    postalCode: 'SW1A 1AA',
    country: 'UK',
    phone: '+44 20 7946 5555',
    email: 'oliver.white@greenplanet.co.uk',
  },
  {
    addressId: 'A008',
    type: 'consignee',
    company: 'Aussie Global Traders',
    name: 'Rebecca Clarke',
    street: '220 Collins Street',
    city: 'Melbourne',
    state: 'VIC',
    postalCode: '3000',
    country: 'Australia',
    phone: '+61 3 9650 8800',
    email: 'rebecca@aussieglobal.com.au',
  },
  {
    addressId: 'A009',
    type: 'buyer',
    company: 'MediTech Supplies',
    name: 'Carlos Ramirez',
    ...
    email: 'c.ramirez@meditech.mx',
  },
  {
    addressId: 'A010',
    type: 'other',
    company: 'Continental Forwarders Ltd.',
    name: 'Fatima Al-Sayed',
    street: 'Plot 88, Industrial Area 2',
    city: 'Sharjah',
    state: 'SH',
    postalCode: '00000',
    country: 'UAE',
    phone: '+971 6 557 2233',
    email: 'fatima@continentalfw.com',
  },
];
